...
![Executive Summary](Loan_Default_Risk_Dashboard/page1_executive_summary.png)
- **Page 2 — Applicant Risk Profiles:** Default rate broken down by education, income type, gender and family status
![Applicant Risk Profiles](Loan_Default_Risk_Dashboard/page2_risk_profiles.png)
- **Page 3 — Behavioral Signals:** Credit history and payment behavior patterns that predict default
![Behavioral Signals](Loan_Default_Risk_Dashboard/page3_behavioral_signals.png)
...
![Financial Analysis](Loan_Default_Risk_Dashboard/page4_financial_analysis.png)
