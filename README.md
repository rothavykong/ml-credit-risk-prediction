...
The Power BI dashboard picks up where the model ends — translating predictions into business decisions.

### Page 1 — Executive Summary
![Executive Summary](screenshots/page1_executive_summary.png)

### Page 2 — Applicant Risk Profiles
![Applicant Risk Profiles](screenshots/page2_risk_profiles.png)

### Page 3 — Behavioral Signals
![Behavioral Signals](screenshots/page3_behavioral_signals.png)

### Page 4 — Financial Cost Analysis
![Financial Cost Analysis](screenshots/page4_financial_analysis.png)

📄 [View Full Dashboard PDF](Loan_Default_Risk_Dashboard.pdf)
